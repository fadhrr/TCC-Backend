...
VALUES
  ...
  (
    14,
    'MalaM',
    'Linus sedang belajar tentang palindrom. Ia ingin mencari tahu apakah sebuah kata tersebut merupakan palindrom atau bukan. Bantulah Linus untuk menentukan apakah sebuah kata tersebut merupakan palindrom atau bukan.\n Palindrome adalah kata yang jika dibalik akan tetap sama. Contoh kata palindrom adalah, \'malam\', \'kodok\', dan \'radar\'.',
    1,
    16,
...
VALUES
  ...
  -- Soal 7 - Recursion
  (9, 8, 64),
  -- Soal 8 - Prime Numbers
  (10, 9, 2),
  -- Soal 9 - Sorting
  (11, 10, 3),
  -- Soal 10 - Dynamic Programming
  (15, 11, 16),
  -- Soal 11 - Conditional Statements
  (16, 12, 5),
  -- Soal 12 - String
  (17, 13, 1),
  -- Soal 13 - Array
  ...
  -- Soal 14 - String
  (19, 5, 29),
  -- Soal 14 - Conditional Statements
  (20, 6, 16),
  -- Soal 14 - Pattern
  (21, 9, 2),
  -- Soal 14 - Sorting
...
CREATE TABLE `contest_problem_categories` (
  `id` int(11) NOT NULL,
  `contest_problem_id` int(10) UNSIGNED NOT NULL,
  `category_id` int(10) UNSIGNED NOT NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci;
...
--
INSERT INTO
  `contest_problem_categories` (`id`, `contest_problem_id`, `category_id`)
VALUES
  (1, 1, 5),
  -- Soal 1 - String
  (2, 2, 29),
